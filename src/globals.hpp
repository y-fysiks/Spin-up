...
inline greatapi::TWheel *right_encoder =
    new greatapi::TWheel_RotationSensor(right_tracking_port, false, 2.75);
inline greatapi::TWheel *left_encoder =
    new greatapi::TWheel_RotationSensor(left_tracking_port, false, 2.75);
inline greatapi::TWheel *rear_encoder =
    new greatapi::TWheel_RotationSensor(rear_tracking_port, false, 2.75);
// odometry object
